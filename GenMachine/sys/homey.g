...
var motorCurrent = move.axes[1].current
...
G1 H2 Y0.05 F10000	; energise motors to ensure they are not stalled

M400 				; make sure everything has stopped before we change the motor currents
M906 Y300 Z300 		    ; drop motor currents

G1 H4 Z3 F5000		; move Z, stopping motion if stall detected
G1 H1 Y-200 F5000 	; move stopping at the endstop
...
M906 Y{var.motorCurrent} Z{var.zCurrent}    		; motor currents back to 100%
