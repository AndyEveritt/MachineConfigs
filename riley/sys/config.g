...
M584 E3:4         				; set extruder drivers

M98 P"resetaxislimit.g"                                 ; Set axis maxima & minima
M208 C0:240				                                ; Set axis maxima & minima
M92 X100 Y100 Z1600 C200 E396:396				            ; Set steps per mm assuming x16 microstepping
M350 E16:16 I1 									        ; Configure microstepping with interpolation
M350 C16 I1
M350 X16 Y16 Z16 I1										; Configure microstepping with interpolation
M566 X400 Y400 Z8 C2 E100:100           					; Set maximum instantaneous speed changes (mm/min)
M203 X35000 Y35000 Z1200 C10000 E5000:5000               	; Set maximum speeds (mm/min)
M201 X6000 Y6000 Z400 C500 E1000:1000            			; Set accelerations (mm/s^2)
...
; Tool 1 heater
M308 S2 P"temp2" Y"thermistor" A"V6 - 0.25" T100000 B4725 C7.06e-8 	; Set thermistor
